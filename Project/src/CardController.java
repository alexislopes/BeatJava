...
public class CardController implements Controller {
    ...
    @Override
    public ArrayList<Model.Card> search(long userID) {
    ...
    public String getPath(String message){
        return model.getCardPath(model.getCardId(model.findKeyWord(message)));
    }
    ...
    @Override
    public void validateUser(Update update) { }
